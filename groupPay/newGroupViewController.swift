...
class newGroupViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func addPersonButtonPressed(_ sender: AnyObject) {
        ...
        let x = Person(name: nameField.text!, totalPlusMinus : zero, transactions: [], currentPay: 0.0, currentPlusMinus: 0.0, phoneNumber: phoneField.text!, email: emailField.text!, toPaySummary: "", toBePaidSummary: "", totalPaid: 0.0)
